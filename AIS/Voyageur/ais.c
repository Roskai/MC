...
Carte carte = {{{0, 0}, {3, 3}, {4, 1}, {1, 9}, {7, 6}, {2, 1}, {9, 8}, {3, 5}, {4, 6}, {5, 9}, {3, 9}, {0, 4}, {8, 5}, {2, 6}, {6, 1}, {7, 8}, {5, 2}, {3, 6}, {6, 5}, {1, 8}, {7, 1}, {7, 0}, {7, 3}, {1, 1}, {3, 1}, {5, 1}, {6, 0}, {8, 4}, {1, 4}, {1, 6}}, 30};
                 ...
                 int *nbClones, int *nbNouveaux)
{
    ...
    if (argc == 6)
    {
        ...
        else if (sscanf(argv[2], "%d", nN) != 1)
        {
            fprintf(stderr, "\n%s n'est pas un entier\n", argv[2]);
            printUsage = 1;
        }
        else if (sscanf(argv[3], "%d", dD) != 1)
        {
            fprintf(stderr, "\n%s n'est pas un entier\n", argv[3]);
            printUsage = 1;
        }
        else if (sscanf(argv[4], "%d", nbGenerations) != 1)
        {
            fprintf(stderr, "\n%s n'est pas un entier\n", argv[4]);
            printUsage = 1;
        }
        else if (sscanf(argv[5], "%d", nbGenerationsInjection) != 1)
        {
            fprintf(stderr, "\n%s n'est pas un entier\n", argv[5]);
            printUsage = 1;
        }
